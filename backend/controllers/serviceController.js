...
// when empty array or invallid it return empty array ie: []
...
// this function takes date-time slot string and group them into a YYYY-MM-DD with the time
...
export async function createService(req, res){
    try {
        const b = req.body || {};
        const instruction = parseJsonArrayField(b.instruction)
