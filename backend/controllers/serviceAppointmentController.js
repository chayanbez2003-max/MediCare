...
// this function will pass a new number 
...
// this function will parse the time string and return AM or PM
...
// this function will build the frontend base url
...
// to get all the service appointment
export const getAllServiceAppointments = async (req, res) => {
  try {
    ...
    console.error("getAllServiceAppointments unexpected:", err);
    return res.status(500).json({ success: false, message: "Server error" });
  }
};